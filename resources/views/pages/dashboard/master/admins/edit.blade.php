@extends('layouts.dashboard', [
    'breadcrumbs' => [
        ...
        $user->name => route('dashboard.admins.show', $user->uuid),
        'Edit' => null,
    ],
])
	...
	<section class="row">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body px-4">
					<x-form.layout.horizontal action="{{ route('dashboard.admins.update', $user->uuid) }}" method="PUT" submit-text="Perbarui">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body px-4">
					<x-form.layout.horizontal action="{{ route('dashboard.admins.update.password', $user->uuid) }}" method="PUT" submit-text="Perbarui">
